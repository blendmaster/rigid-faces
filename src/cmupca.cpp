...
IplImage * CMUPCA::returnMinProjVal()
{
    return minProjVal;
}

IplImage * CMUPCA::returnMaxProjVal()
{
    return maxProjVal;
}
...

{
    ...
    *********************************************************************/
    ...
    minProjVal=cvCreateImage(cvSize( 1,nEigens),IPL_DEPTH_64F, 1);
    maxProjVal=cvCreateImage(cvSize( 1,nEigens),IPL_DEPTH_64F, 1);
    cvZero(minProjVal);
    cvZero(maxProjVal);
